...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Bulan Mei 2019 pada 19.27
...
CREATE TABLE `doctor_schedule` (
  ...
  `sunday` varchar(20) NOT NULL DEFAULT '-',
...
(1, 5, '09.00 - 18.00', '09.00 - 11.00', '09.00 - 12.00', '09.00 - 18.00', '14.00 - 20.00', '12.00 - 14.00', '09.00 - 13.00', 1),
(2, 7, '09.00 - 18.00', '09.00 - 18.00', '09.00 - 14.00', '09.00 - 12.00', '-', '-', '-', 3);
...
INSERT INTO `plasma` (`id`, `name`, `title`, `url`, `is_doctor_of_duty`, `is_specialist_doctor`, `is_nurse`, `is_pic_nurse`, `is_image_slide`, `type_id`) VALUES
(1, 'IGD\r\n', 'INSTALASI GAWAT DARURAT (IGD) 24 JAM', 'ugd', 1, 0, 0, 0, 0, 1),
(2, 'Lantai 6-A', 'Rawat Inap LT. 6 Wing A', 'enama', 0, 0, 0, 0, 0, 3),
(3, 'Lantai 6-B', '', '', 0, 0, 0, 0, 0, 3),
(4, 'Lantai 7-A', '', '', 1, 0, 0, 0, 0, 3),
(5, 'Lantai 7-B', '', '', 0, 0, 0, 0, 0, 3),
(6, 'Lantai 8-A', '', '', 0, 0, 0, 0, 0, 3),
(7, 'Obgyn', 'Poliklinik Obgyn', 'obgyn', 1, 0, 0, 0, 0, 2);
